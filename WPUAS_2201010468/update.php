...
<form class="shadow rounded py-4 px-3 my-4" action="update.php?id=<?= $data['no_undi']; ?>" method="POST">
  ...
  <div class="mb-3">
    ...
    <select class="form-select" id="kriteria" name="kriteria">
      ...
      <option value="Bebean" <?php if ($data['kriteria'] == 'Bebean') { echo 'selected'; } ?>>Bebean</option>
      <option value="Jangan" <?php if ($data['kriteria'] == 'Jangan') { echo 'selected'; } ?>>Jangan</option>
      <option value="Kuwir" <?php if ($data['kriteria'] == 'Kuwir') { echo 'selected'; } ?>>Kuwir</option>
      <option value="Pecukan" <?php if ($data['kriteria'] == 'Pecukan') { echo 'selected'; } ?>>Pecukan</option>
      <option value="Bebean Khas Sanur" <?php if ($data['kriteria'] == 'Bebean Khas Sanus') { echo 'selected'; } ?>>Bebean Khas Sanur</option>
      <option value="Kreasi" <?php if ($data['kriteria'] == 'Kreasi') { echo 'selected'; } ?>>Kreasi</option>
    </select>
  </div>
